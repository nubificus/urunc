...
func TestNerdctl(t *testing.T) {
	tests := []containerTestArgs{
		...
		{
			Image:          "harbor.nbfc.io/nubificus/urunc/net-mirage-hvt:latest",
			Name:           "Hvt-mirage-net",
			Devmapper:      false,
			Seccomp:        true,
			StaticNet:      false,
		...
		{
			Image:          "harbor.nbfc.io/nubificus/urunc/net-mirage-spt:latest",
			Name:           "Spt-mirage-net",
			Devmapper:      false,
			Seccomp:        true,
			StaticNet:      false,
		...
		{
			Image:          "harbor.nbfc.io/nubificus/urunc/net-mirage-qemu:latest",
...
func TestCtr(t *testing.T) {
	tests := []containerTestArgs{
		...
		{
			Image:          "harbor.nbfc.io/nubificus/urunc/hello-mirage-hvt:latest",
		...
		{
			Image:          "harbor.nbfc.io/nubificus/urunc/block-test-mirage-hvt:latest",
		...
		{
			Image:          "harbor.nbfc.io/nubificus/urunc/hello-mirage-spt:latest",
		...
		{
			Image:          "harbor.nbfc.io/nubificus/urunc/block-test-mirage-spt:latest",
